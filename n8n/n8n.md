...
## Success!! google인증부터 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
...
## OK! [n8n] 실전 (1) - 매일 아침 달러 환율, 구글 시트에 자동 기록하기 (무료 API) 
...
#### 1단계: Discord Developer Portal 설정
 ...
 2. 왼쪽 메뉴 Bot 클릭 -> Reset Token을 눌러 토큰을 생성하고 복사해 둡니다. (이게 n8n에 들어갈 비밀번호입니다.)
    MTQ4MTEwNzEyMjM5NjU5ODQyNg.GXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
#### 2단계: 서버에 봇 초대하기
 ...
 https://discord.com/oauth2/authorize?client_id=1481107122396598426&permissions=8&integration_type=0&scope=bot
#### 3단계: n8n 연동
