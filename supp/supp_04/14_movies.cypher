// 14_movies.cypher — Neo4j "movies" 데이터셋 (영화 38편 · Neo4j Browser :play movies 와 동일)
// 출처: github.com/neo4j-graph-examples/movies — 전부 MERGE 라 여러 번 적재해도 멱등.
// 적재: python ./_run_cypher.py 14_movies.cypher   (또는 15_movie_text2cypher.py 가 자동 적재)
//
